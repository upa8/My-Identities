...
<!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
       ...
       <a class="navbar-brand" href="index.php">My Identities <img class="img-responsive" src="img/logo.png" alt="Logo" width="80" height="80">  </a>
               </div>
...
<?php 
		...
		include('includes/settings.php');
			...
			$Check_Licence = mysqli_query($con,"SELECT * FROM images WHERE uid = '$User_Id' AND img_type = 2; ");
			if(mysqli_num_rows($Check_Licence)>0){
				echo " You Already have your AADHAR CARD in your wallet . ";
				echo "<br>If you want to change it , go and delete it from wallet";

			}else{
					echo'<form method="POST" enctype="multipart/form-data" action="save_license.php" id="myForm">
									<input type="hidden" name="img_val" id="img_val" value="" />
									</form>

									<form action="licence.php" method="GET">
